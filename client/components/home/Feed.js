...
const tweet = [
  {
    ...
    text: '川の中ではあなたが触る水が一番最後に過ぎ去ったものであり、また、一番最初に来るものである。現在という時も同じである。どこか遠くへ行きなさい。仕事が小さく見えてきて、もっと全体がよく眺められるようになります。不調和やアンバランスがもっとよく見えてきます。猫科の一番小さな動物、つまり猫は、最高傑作である。',
